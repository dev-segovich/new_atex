...
export default function ContactContent() {
	...
	const investorTypes = t("contactPage.investorTypes", {
		returnObjects: true,
	}) as string[];
	const regions = t("contactPage.regions", { returnObjects: true }) as string[];
	const interests = t("contactPage.interests", {
		returnObjects: true,
	}) as string[];
	...
	return (
		<div className="min-h-screen bg-[#f9fbfc] text-[#364350]">
			...
			<div className="max-w-3xl mx-auto px-6 py-16">
				<h2 className="text-4xl font-bold mb-6 text-center text-[#364350]">
				...
				>
					...
					<h3 className="text-xl font-semibold mb-2">
						1. {t("contactPage.sections.basic")}
					</h3>
					...
					<div className="mt-10">
						<h3 className="text-xl font-semibold mb-2">
							3. {t("contactPage.sections.accreditation")}
						</h3>
					...
					<h3 className="text-xl font-semibold mt-8 mb-2">
						4. {t("contactPage.sections.region")}
					</h3>
					<select
						id="region"
						name="region"
					...
					>
						<option value="">
							{t("contactPage.placeholders.selectOption")}
						</option>
					...
					<h3 className="text-xl font-semibold mt-8 mb-2">
						5. {t("contactPage.sections.minimum")}
					</h3>
					...
					<fieldset className="mt-8">
						<legend className="text-xl font-semibold mb-2">
							6. {t("contactPage.sections.interests")}
						</legend>
						<div className="space-y-2">
					...
					<h3 className="text-xl font-semibold mt-8 mb-2">
						7. {t("contactPage.sections.referral")}
					</h3>
					<textarea
						id="referralSource"
						name="referralSource"
					...
					<h3 className="text-xl font-semibold mt-8 mb-2">
						8. {t("contactPage.sections.message")}
					</h3>
					<textarea
						id="message"
						name="message"
					...
					<p className="text-sm text-gray-600 italic mt-6 whitespace-pre-line">
						<strong>{t("contactPage.disclaimer.label")}</strong>
						{t("contactPage.disclaimer.text")}
					</p>
